...
<body>
    <div class="container">
        ...
        <form method="POST" action="{{ url('auth/login') }}">
            ...
            <a href="{{ route('googleLogin') }}" class="google-login-btn">
            ...
            <a href="{{ route('githubLogin') }}" class="google-login-btn">
        ...
        <div class="mt-3 text-center">
            <a href="{{ route('clientRegister') }}">Don't have an account? Register</a>
        </div>
    </div>
